...
int main(int _argc, const char* _argv[])
{
    ...
    {
        texturec::help("Input file must be specified.");
        return bx::kExitFailure;
    }
    ...
    {
        texturec::help("Output file must be specified.");
        return bx::kExitFailure;
    }
    ...
    if (NULL == saveAs)
    {
        texturec::help("Output file format must be specified.");
        return bx::kExitFailure;
    }

    texturec::Options options;
    ...
    if (NULL != type)
    {
        ...
        {
            texturec::help("Invalid format specified.");
            return bx::kExitFailure;
        }
    }
    ...
    if (NULL != bx::strFindI(saveAs, "png"))
    {
        ...
        {
            texturec::help("Ouput PNG format must be RGBA8.");
            return bx::kExitFailure;
        }
    }
    ...
    if (NULL != quality)
    {
        ...
        default:
            texturec::help("Invalid quality specified.");
            return bx::kExitFailure;
        }
    }
    ...
    {
        texturec::help("Failed to open input file.", err);
        return bx::kExitFailure;
    }
    ...
    if (0 == inputSize)
    {
        texturec::help("Failed to read input file.", err);
        return bx::kExitFailure;
    }
    ...
    if (NULL != output)
    {
        ...
        if (bx::open(&writer, outputFileName, false, &err))
        {
            ...
            if (!err.isOk())
            {
                texturec::help(NULL, err);
                return bx::kExitFailure;
            }
        }
        else
        {
            texturec::help("Failed to open output file.", err);
            return bx::kExitFailure;
        }
        ...
        if (validate)
        {
            ...
            {
                texturec::help("Failed to validate file.", err);
                return bx::kExitFailure;
            }
            ...
            {
                texturec::help("Validation failed, image headers are different.");
                return bx::kExitFailure;
            }

            {
                ...
                for (uint8_t lod = 0; lod < numMips; ++lod)
                {
                    for (uint16_t side = 0; side < numSides; ++side)
                    {
                        ...
                        {
                            texturec::help("Validation failed, image mip/layer/side are different.");
                            return bx::kExitFailure;
                        }

                        if (0 != bx::memCmp(srcMip.m_data, dstMip.m_data, srcMip.m_size))
                        {
                            texturec::help("Validation failed, image content are different.");
                            return bx::kExitFailure;
                        }
                    }
                }
